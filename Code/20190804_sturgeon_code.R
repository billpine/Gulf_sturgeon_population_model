...
"Scenario1" <- function(L95.R0=c(4625,1200),mu.R0=c(9970,2605),U95.R0=c(14452,3770),L95.U1=1,mu.U1=1,U95.U1=1,L95.U2=0.094,mu.U2=0.089,U95.U2=0.077){
  ...
  points(T82,111,pch=19,col="purple")
  points(T83,119,pch=19,col="purple")
  points(T84,117,pch=19,col="purple")
  points(T85,108,pch=19,col="purple")
  points(T86,103,pch=19,col="purple")
  points(T87,88,pch=19,col="purple")
  points(T88,89,pch=19,col="purple")
  points(T89,90,pch=19,col="purple")
  points(T90,117,pch=19,col="purple")
  points(T92,155,pch=19,col="purple")
  points(T98,260,pch=19,col="purple")
  points(T2003,350,pch=19,col="purple")
